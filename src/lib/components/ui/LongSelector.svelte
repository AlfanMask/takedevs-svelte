...
<div
    id="selector"
    class="w-full flex justify-between items-center px-5 py-2 rounded {item.isActive ? 'bg-accent' : 'bg-transparent'} {!item.isActive ? 'border-2 border-solid border-secondary' : ''} cursor-pointer"
    on:click
>
