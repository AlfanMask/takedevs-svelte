...
<div id="faq" class="container mb-20 mx-auto lg:px-0 px-5">
	...
	<div class="faq-items grid grid-cols-1 lg:grid-cols-2 gap-10">
		...
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-cp" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="Bisakah saya melihat contoh company profile yang telah Anda buat?" desc="Tentu saja! Anda bisa melihat contoh hasil company profile kami di section Proyek Kami di atas." />
