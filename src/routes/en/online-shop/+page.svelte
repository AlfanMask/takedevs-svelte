...
<div id="faq" class="container mb-20 mx-auto lg:px-0 px-5">
	...
	<div class="faq-items grid grid-cols-1 lg:grid-cols-2 gap-10">
		...
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="Do you offer support after the project is completed?" desc="Project completion time depends on the complexity and scale of the project. However, we will provide a clear time estimate before starting the project." />
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="How long does it take to complete a project?" desc="Yes, we offer support after the project is completed. If you have any questions or issues, we are here to help." />
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="What is the cost of consultation services?" desc="Yes, we offer a satisfaction guarantee. If you are not satisfied with our work, we can make revisions to ensure you are happy." />
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="Do you offer a satisfaction guarantee?" desc="Consultation services are provided free of charge." />
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="Are there any additional fees I should be aware of?" desc="We accept payments through bank transfer and e-wallet." />
		<AccordionItem isHideOnMobile icon="fa-solid fa-info" iconBgColor="bg-primary-os" iconColor="text-white" textColor="text-secondary-lp-os-cp-cs" title="What are the payment methods?" desc="Additional fees may apply for extra services or special requests. However, we will provide clear information about any additional costs before starting the project." />
	</div>
</div>
